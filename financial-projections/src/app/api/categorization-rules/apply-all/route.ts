...
const ApplyAllCategorizationRulesRequestSchema = z.object({
...
export const { POST } = defineRoute({
  ...
  responses: {
    200: { description: 'All categorization rules applied successfully' },
    400: { description: 'Invalid request body' },
    404: { description: 'No categorization rules found' },
